...
function systemInstructionFor(
  ...
  return [
    ...
    `- Use only qualitative confidence language, never invented percentages: "strongly concerning for," "the leading possibility is," "several explanations remain possible," or "not enough information yet." Never state a fake percentage.`,

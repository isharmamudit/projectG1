...
import { ArrowLeft, ArrowUpRight, Heart, HeartPulse, Leaf, MessageCircle, Mic, PersonStanding, TriangleAlert, WifiOff, Calendar, Watch } from 'lucide-react'
      ...
      <FadeIn className="relative z-30 mb-6 hidden w-full items-center justify-between rounded-2xl border border-border bg-surface/70 px-5 py-3 backdrop-blur-xl md:flex">
        ...
        <nav className="hidden items-center gap-2 md:flex">
          ...
          <Link
            to="/sehat"
            title="SEHAT"
            className="flex items-center gap-1.5 rounded-xl bg-tint-sage/15 px-4 py-2 text-sm font-bold text-tint-sage transition-transform hover:scale-[1.03] active:scale-95"
          >
          ...
          <Link
            ...
            className="flex items-center gap-1.5 rounded-xl bg-tint-violet/15 px-4 py-2 text-sm font-bold text-tint-violet transition-transform hover:scale-[1.03] active:scale-95"
          >
          ...
          <Link
            ...
            className="flex items-center gap-1.5 rounded-xl bg-tint-blue/15 px-4 py-2 text-sm font-bold text-tint-blue transition-transform hover:scale-[1.03] active:scale-95"
          >
          ...
          <Link
            to="/vitals"
            title="Smartwatch Vitals"
            className="flex items-center gap-1.5 rounded-xl bg-tint-amber/15 px-4 py-2 text-sm font-bold text-tint-amber transition-transform hover:scale-[1.03] active:scale-95"
          >
            <Watch className="size-3.5" strokeWidth={2.5} />
            Vitals
          </Link>
          <Link
            to="/voice"
            title="Talk to CareBuddy"
            className="flex items-center gap-1.5 rounded-xl bg-ink px-4 py-2 text-sm font-bold text-tint-amber transition-all hover:scale-[1.03] active:scale-95"
          >

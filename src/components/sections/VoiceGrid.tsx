...
const TRANSCRIPT_LINES = [
  { role: 'ai', text: "Hello, I'm your CareBuddy health assistant. Let's build your report together." },
...
const FEATURES_DEEP = [
  {
    ...
    description: 'Hindi, Bhojpuri, Tamil, Hinglish — ask CareBuddy anything in the language you think in. It translates, simplifies medical terms, and responds instantly.',
  ...
  },
  {
    ...
    description: 'Speak your symptoms out loud. CareBuddy walks through 10 sequential clinical questions, compiles a structured doctor report, and schedules next steps.',
  ...
  },
  {
    ...
    description: 'Photograph skin issues, upload heart scans and X-rays, or scan printed prescriptions. CareBuddy classifies anomalies and formats them for your profile.',
  ...
  },
  {
    ...
    description: 'Track and correct your form live through your phone camera. CareBuddy evaluates pose coordinates, scores alignment accuracy, and guides hold timers.',
                ...
                <>
                  ...
                  <div className="relative flex h-72 flex-col items-center justify-center overflow-hidden rounded-3xl bg-pastel-blue text-ink sm:h-80 p-6">
                    ...
                    <div className="mt-6 flex items-center gap-2">
                      ...
                      <span className="text-xs font-black uppercase">Active Engine: {selectedLanguage}-CareBuddy</span>
                    </div>
                  </div>
              ...
              {currentFeature.id === 'voice' && (
                <>
                  ...
                  <div className="relative flex h-72 flex-col items-center justify-center overflow-hidden rounded-3xl bg-pastel-amber text-ink sm:h-80">
                    ...
                    <p className="relative z-10 mt-5 font-display text-xl font-black uppercase">CareBuddy is listening</p>

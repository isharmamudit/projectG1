...
const TESTIMONIALS = [
  {
    ...
    quote:
      'CareBuddy understood my symptoms in Kannada and helped me figure out it was a vitamin deficiency — no hospital trip needed. Saved me hours.',
  ...
  },
  {
    ...
    quote:
      'My patients now come in with clear symptom logs from CareBuddy. It saves time and I can give a much more accurate diagnosis in fewer minutes.',
  ...
  },
  {
    ...
    quote:
      'I travel a lot and never remember my medical history. CareBuddy keeps everything in one place and generates a report I can hand to any doctor.',
  ...
  },
  {
    ...
    quote:
      'As someone who gets anxious about health, having CareBuddy give me a calm, clear breakdown of my symptoms reduces my stress so much.',
  ...
  },
  {
    ...
    quote:
      'At my age I have multiple conditions. CareBuddy tracks everything — medicines, reports, blood work — and reminds me what matters.',
  ...
  },
  {
    ...
    quote:
      'CareBuddy bridges the gap between doctor visits beautifully. Patients stay informed and engaged with their health between appointments.',

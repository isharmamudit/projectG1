...
export const COPY: Record<string, Copy> = {
  en: {
    ...
    heroSubtitle:
      'Ask in your dialect. Speak your symptoms. Photo a prescription. CareBuddy translates clinical complexity into native Indian tongues instantly.',
    startConsultation: 'Start Consultation',
    exploreFeatures: 'Explore features',
    consultG1: 'Consult CareBuddy',
    tapToExplore: 'Tap to explore features',
    chooseLanguage: 'Choose your language',
    navItems: { 'Why CareBuddy': 'Why CareBuddy', Features: 'Features', India: 'India', Trust: 'Trust' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'Interactive Capabilities', heading: 'Deep dive into', headingAccent: 'CareBuddy.' },
    testimonials: {
      eyebrow: 'Real Stories',
      heading: 'Heard across',
      headingAccent: 'every state.',
      subhead: 'From grandmothers in Varanasi to doctors in Mumbai — CareBuddy speaks your language.',
    },
    problems: {
      eyebrow: "Explore what's",
      tabProblems: 'Competitor Gaps',
      tabSolutions: 'CareBuddy Solutions',
      badgeSolutions: 'CareBuddy Answers',
      heading: 'What every health app gets wrong.',
      subhead:
        'Existing apps were built for English-speaking, urban, tech-fluent users. CareBuddy was built for everyone else.',
      ...
      solutions: [
        { headline: 'Built for rural India', sub: "Low bandwidth, any phone, any dialect — CareBuddy works where others don't." },
        ...
        { headline: 'One record, all providers', sub: 'From Practo to Apollo to the local clinic — CareBuddy unifies everything.' },
    ...
    horizontalScroll: {
      eyebrow: 'What CareBuddy does',
      scrollHint: 'Scroll to explore features',
      featureWord: 'Feature',
      closingTitle: 'More coming soon.',
      closingCta: 'See Voice AI ↓',
      cards: [
        { tag: 'Language', title: 'Chat', sub: 'In your language, your dialect', body: 'Hindi, Bhojpuri, Tamil, Hinglish — ask CareBuddy anything in the language you think in. Expands from the bottom right corner.' },
        { tag: 'Consultation', title: 'Voice', sub: 'Talk — get a doctor report', body: 'Speak your symptoms out loud. CareBuddy asks 10 clinical questions, generates a structured report, and sends it to your doctor.' },
        { tag: 'Visual AI', title: 'Scan', sub: 'Photo your symptoms', body: 'Photograph a rash, burn, hair issue or upload an X-ray. CareBuddy reads it and flags what needs attention.' },
        { tag: 'Movement', title: 'Yoga', sub: 'Real-time posture coaching', body: 'Hold a pose in front of your camera. CareBuddy watches your form in real time and tells you when to move to the next.' },
    ...
    chatbot: {
      title: 'CareBuddy Assistant',
      subtitle: 'Ask about symptoms, in your language',
      placeholder: 'Type your message…',
      greeting: "Hi, I'm CareBuddy. Tell me what's bothering you, in any language.",
  ...
  hi: {
    ...
    heroSubtitle:
      'अपनी भाषा में पूछें। अपने लक्षण बोलें। पर्ची की फोटो खींचें। CareBuddy तुरंत जटिल चिकित्सा जानकारी को आपकी भाषा में समझाता है।',
    startConsultation: 'परामर्श शुरू करें',
    exploreFeatures: 'सुविधाएं देखें',
    consultG1: 'CareBuddy से बात करें',
    tapToExplore: 'सुविधाएं देखने के लिए टैप करें',
    chooseLanguage: 'अपनी भाषा चुनें',
    navItems: { 'Why CareBuddy': 'क्यों CareBuddy', Features: 'सुविधाएं', India: 'भारत', Trust: 'भरोसा' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'इंटरएक्टिव सुविधाएं', heading: 'गहराई से जानें', headingAccent: 'CareBuddy को.' },
    testimonials: {
      eyebrow: 'सच्ची कहानियां',
      heading: 'हर राज्य में',
      headingAccent: 'सुनी गई।',
      subhead: 'वाराणसी की दादी-नानी से लेकर मुंबई के डॉक्टरों तक — CareBuddy आपकी भाषा बोलता है।',
    },
    problems: {
      eyebrow: 'देखें',
      tabProblems: 'दूसरों की कमियां',
      tabSolutions: 'CareBuddy के समाधान',
      badgeSolutions: 'CareBuddy के जवाब',
      heading: 'हर हेल्थ ऐप कहां चूक जाता है।',
      subhead: 'मौजूदा ऐप्स अंग्रेज़ी बोलने वाले, शहरी, तकनीक-जानकार लोगों के लिए बने थे। CareBuddy बाकी सबके लिए बनाया गया है।',
      ...
      solutions: [
        { headline: 'ग्रामीण भारत के लिए बनाया गया', sub: 'धीमा इंटरनेट, कोई भी फ़ोन, कोई भी भाषा — CareBuddy वहां काम करता है जहां बाकी नहीं करते।' },
        ...
        { headline: 'एक रिकॉर्ड, सभी डॉक्टर', sub: 'Practo से Apollo और स्थानीय क्लिनिक तक — CareBuddy सबको जोड़ता है।' },
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddy क्या करता है',
      scrollHint: 'सुविधाएं देखने के लिए स्क्रॉल करें',
      featureWord: 'फीचर',
      closingTitle: 'जल्द और आ रहा है।',
      closingCta: 'Voice AI देखें ↓',
      cards: [
        { tag: 'भाषा', title: 'चैट', sub: 'आपकी भाषा, आपकी बोली में', body: 'हिंदी, भोजपुरी, तमिल, हिंग्लिश — CareBuddy से अपनी सोच की भाषा में कुछ भी पूछें। नीचे दाईं ओर से खुलता है।' },
        { tag: 'परामर्श', title: 'वॉइस', sub: 'बोलें — डॉक्टर रिपोर्ट पाएं', body: 'अपने लक्षण ज़ोर से बोलें। CareBuddy 10 चिकित्सा सवाल पूछता है, एक संरचित रिपोर्ट बनाता है, और उसे आपके डॉक्टर को भेजता है।' },
        { tag: 'विज़ुअल AI', title: 'स्कैन', sub: 'अपने लक्षणों की फोटो लें', body: 'चकत्ते, जलन, बालों की समस्या की फोटो लें या एक्स-रे अपलोड करें। CareBuddy इसे पढ़ता है और जो ध्यान देने योग्य है उसे बताता है।' },
        { tag: 'मूवमेंट', title: 'योग', sub: 'रीयल-टाइम मुद्रा मार्गदर्शन', body: 'अपने कैमरे के सामने एक मुद्रा बनाए रखें। CareBuddy रीयल-टाइम में आपकी मुद्रा देखता है और बताता है कि अगली मुद्रा कब करनी है।' },
    ...
    chatbot: {
      title: 'CareBuddy सहायक',
      subtitle: 'अपनी भाषा में लक्षणों के बारे में पूछें',
      placeholder: 'अपना संदेश लिखें…',
      greeting: 'नमस्ते, मैं CareBuddy हूं। किसी भी भाषा में बताएं कि आपको क्या परेशानी है।',
  ...
  bn: {
    ...
    heroSubtitle:
      'নিজের ভাষায় জিজ্ঞাসা করুন। আপনার উপসর্গ বলুন। প্রেসক্রিপশনের ছবি তুলুন। CareBuddy তাৎক্ষণিকভাবে জটিল চিকিৎসা তথ্য আপনার ভাষায় বুঝিয়ে দেয়।',
    startConsultation: 'পরামর্শ শুরু করুন',
    exploreFeatures: 'বৈশিষ্ট্য দেখুন',
    consultG1: 'CareBuddy-এর সাথে কথা বলুন',
    tapToExplore: 'বৈশিষ্ট্য দেখতে ট্যাপ করুন',
    chooseLanguage: 'আপনার ভাষা বেছে নিন',
    navItems: { 'Why CareBuddy': 'কেন CareBuddy', Features: 'বৈশিষ্ট্য', India: 'ভারত', Trust: 'বিশ্বাস' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'ইন্টারঅ্যাক্টিভ বৈশিষ্ট্য', heading: 'গভীরে জানুন', headingAccent: 'CareBuddy-কে.' },
    testimonials: {
      eyebrow: 'সত্যি গল্প',
      heading: 'প্রতিটি রাজ্যে',
      headingAccent: 'শোনা গেছে।',
      subhead: 'বারাণসীর ঠাকুমা থেকে মুম্বাইয়ের ডাক্তার — CareBuddy আপনার ভাষায় কথা বলে।',
    },
    problems: {
      eyebrow: 'দেখুন',
      tabProblems: 'প্রতিযোগীদের ঘাটতি',
      tabSolutions: 'CareBuddy-এর সমাধান',
      badgeSolutions: 'CareBuddy-এর উত্তর',
      heading: 'প্রতিটি হেলথ অ্যাপ যেখানে ভুল করে।',
      subhead: 'বর্তমান অ্যাপগুলো ইংরেজি-ভাষী, শহুরে, প্রযুক্তি-দক্ষ ব্যবহারকারীদের জন্য তৈরি। CareBuddy বাকি সবার জন্য তৈরি।',
      ...
      solutions: [
        { headline: 'গ্রামীণ ভারতের জন্য তৈরি', sub: 'কম গতির ইন্টারনেট, যেকোনো ফোন, যেকোনো ভাষা — CareBuddy সেখানে কাজ করে যেখানে অন্যরা করে না।' },
        ...
        { headline: 'একটি রেকর্ড, সব চিকিৎসক', sub: 'Practo থেকে Apollo এবং স্থানীয় ক্লিনিক পর্যন্ত — CareBuddy সবকিছু একত্র করে।' },
    ...
    india: {
      ...
      askIn: 'CareBuddy-কে জিজ্ঞাসা করুন',
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddy কী করে',
      scrollHint: 'বৈশিষ্ট্য দেখতে স্ক্রল করুন',
      featureWord: 'বৈশিষ্ট্য',
      closingTitle: 'শীঘ্রই আরও আসছে।',
      closingCta: 'Voice AI দেখুন ↓',
      cards: [
        { tag: 'ভাষা', title: 'চ্যাট', sub: 'আপনার ভাষায়, আপনার উপভাষায়', body: 'হিন্দি, ভোজপুরি, তামিল, হিংলিশ — আপনি যে ভাষায় ভাবেন সেই ভাষায় CareBuddy-কে যা খুশি জিজ্ঞাসা করুন। নিচের ডান কোণ থেকে খোলে।' },
        { tag: 'পরামর্শ', title: 'ভয়েস', sub: 'কথা বলুন — ডাক্তার রিপোর্ট পান', body: 'আপনার উপসর্গ জোরে বলুন। CareBuddy ১০টি ক্লিনিক্যাল প্রশ্ন জিজ্ঞাসা করে, একটি কাঠামোবদ্ধ রিপোর্ট তৈরি করে, এবং তা আপনার ডাক্তারের কাছে পাঠায়।' },
        { tag: 'ভিজ্যুয়াল AI', title: 'স্ক্যান', sub: 'আপনার উপসর্গের ছবি তুলুন', body: 'র‍্যাশ, পোড়া, চুলের সমস্যার ছবি তুলুন বা এক্স-রে আপলোড করুন। CareBuddy এটি পড়ে এবং যা মনোযোগ প্রয়োজন তা চিহ্নিত করে।' },
        { tag: 'মুভমেন্ট', title: 'যোগ', sub: 'রিয়েল-টাইম ভঙ্গি প্রশিক্ষণ', body: 'আপনার ক্যামেরার সামনে একটি ভঙ্গি ধরে রাখুন। CareBuddy রিয়েল-টাইমে আপনার ফর্ম দেখে এবং পরবর্তীতে কখন যেতে হবে তা বলে।' },
    ...
    chatbot: {
      title: 'CareBuddy সহায়ক',
      subtitle: 'আপনার ভাষায় উপসর্গ সম্পর্কে জিজ্ঞাসা করুন',
      placeholder: 'আপনার বার্তা লিখুন…',
      greeting: 'হ্যালো, আমি CareBuddy। যেকোনো ভাষায় বলুন আপনার কী সমস্যা হচ্ছে।',
  ...
  ta: {
    ...
    heroSubtitle:
      'உங்கள் மொழியில் கேளுங்கள். உங்கள் அறிகுறிகளைப் பேசுங்கள். மருந்துச் சீட்டின் புகைப்படம் எடுங்கள். CareBuddy உடனடியாக மருத்துவ தகவலை உங்கள் மொழியில் விளக்குகிறது.',
    startConsultation: 'ஆலோசனையைத் தொடங்கு',
    exploreFeatures: 'அம்சங்களைப் பார்க்க',
    consultG1: 'CareBuddy உடன் பேசுங்கள்',
    tapToExplore: 'அம்சங்களைப் பார்க்க தட்டவும்',
    chooseLanguage: 'உங்கள் மொழியைத் தேர்ந்தெடுக்கவும்',
    navItems: { 'Why CareBuddy': 'ஏன் CareBuddy', Features: 'அம்சங்கள்', India: 'இந்தியா', Trust: 'நம்பிக்கை' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'ஊடாடும் திறன்கள்', heading: 'ஆழமாக அறிய', headingAccent: 'CareBuddy.' },
    testimonials: {
      eyebrow: 'உண்மைக் கதைகள்',
      heading: 'ஒவ்வொரு மாநிலத்திலும்',
      headingAccent: 'கேட்கப்பட்டது.',
      subhead: 'வாரணாசியின் பாட்டிகள் முதல் மும்பையின் மருத்துவர்கள் வரை — CareBuddy உங்கள் மொழியில் பேசுகிறது.',
    },
    problems: {
      eyebrow: 'பாருங்கள்',
      tabProblems: 'போட்டியாளர் குறைபாடுகள்',
      tabSolutions: 'CareBuddy தீர்வுகள்',
      badgeSolutions: 'CareBuddy பதில்கள்',
      heading: 'ஒவ்வொரு சுகாதார ஆப்பும் தவறு செய்யும் இடம்.',
      subhead: 'தற்போதைய ஆப்கள் ஆங்கிலம் பேசும், நகர்ப்புற, தொழில்நுட்ப அறிவுள்ள பயனர்களுக்காக உருவாக்கப்பட்டவை. CareBuddy மற்ற அனைவருக்காகவும் உருவாக்கப்பட்டது.',
      ...
      solutions: [
        { headline: 'கிராமப்புற இந்தியாவுக்காக உருவாக்கப்பட்டது', sub: 'குறைந்த வேக இணையம், எந்த மொபைலும், எந்த மொழியும் — மற்றவை வேலை செய்யாத இடத்தில் CareBuddy வேலை செய்கிறது.' },
        ...
        { headline: 'ஒரு பதிவு, அனைத்து மருத்துவர்களும்', sub: 'Practo முதல் Apollo மற்றும் உள்ளூர் மருத்துவமனை வரை — CareBuddy அனைத்தையும் இணைக்கிறது.' },
    ...
    india: {
      ...
      askIn: 'CareBuddy-இடம் கேளுங்கள்',
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddy என்ன செய்கிறது',
      scrollHint: 'அம்சங்களைப் பார்க்க ஸ்க்ரோல் செய்யவும்',
      featureWord: 'அம்சம்',
      closingTitle: 'மேலும் விரைவில் வருகிறது.',
      closingCta: 'Voice AI-ஐப் பார்க்க ↓',
      cards: [
        { tag: 'மொழி', title: 'சாட்', sub: 'உங்கள் மொழியில், உங்கள் பேச்சுவழக்கில்', body: 'இந்தி, போஜ்புரி, தமிழ், ஹிங்லிஷ் — நீங்கள் நினைக்கும் மொழியில் CareBuddy-இடம் எதுவும் கேளுங்கள். கீழ் வலது மூலையிலிருந்து விரிவடையும்.' },
        { tag: 'ஆலோசனை', title: 'குரல்', sub: 'பேசுங்கள் — மருத்துவர் அறிக்கை பெறுங்கள்', body: 'உங்கள் அறிகுறிகளை சத்தமாகப் பேசுங்கள். CareBuddy 10 மருத்துவ கேள்விகளைக் கேட்டு, ஒரு கட்டமைக்கப்பட்ட அறிக்கையை உருவாக்கி, அதை உங்கள் மருத்துவருக்கு அனுப்புகிறது.' },
        { tag: 'விஷுவல் AI', title: 'ஸ்கேன்', sub: 'உங்கள் அறிகுறிகளை புகைப்படம் எடுக்கவும்', body: 'சொறி, தீக்காயம், முடி பிரச்சனையை புகைப்படம் எடுக்கவும் அல்லது எக்ஸ்-ரே பதிவேற்றவும். CareBuddy அதைப் படித்து கவனம் தேவைப்படுவதைக் குறிக்கிறது.' },
        { tag: 'இயக்கம்', title: 'யோகா', sub: 'நேரடி தோரணை பயிற்சி', body: 'உங்கள் கேமராவின் முன் ஒரு தோரணையை வைத்திருங்கள். CareBuddy நேரடியாக உங்கள் தோரணையைப் பார்த்து அடுத்ததற்கு எப்போது செல்ல வேண்டும் எனக் கூறுகிறது.' },
    ...
    chatbot: {
      title: 'CareBuddy உதவியாளர்',
      subtitle: 'உங்கள் மொழியில் அறிகுறிகளைப் பற்றி கேளுங்கள்',
      placeholder: 'உங்கள் செய்தியை தட்டச்சு செய்யவும்…',
      greeting: 'வணக்கம், நான் CareBuddy. உங்களுக்கு என்ன பிரச்சனை என்று எந்த மொழியிலும் சொல்லுங்கள்.',
  ...
  te: {
    ...
    heroSubtitle:
      'మీ భాషలో అడగండి. మీ లక్షణాలను మాట్లాడండి. ప్రిస్క్రిప్షన్ ఫోటో తీయండి. CareBuddy తక్షణమే వైద్య సమాచారాన్ని మీ భాషలో వివరిస్తుంది.',
    startConsultation: 'సంప్రదింపు ప్రారంభించండి',
    exploreFeatures: 'ఫీచర్లను చూడండి',
    consultG1: 'CareBuddyతో మాట్లాడండి',
    tapToExplore: 'ఫీచర్లను చూడటానికి నొక్కండి',
    chooseLanguage: 'మీ భాషను ఎంచుకోండి',
    navItems: { 'Why CareBuddy': 'ఎందుకు CareBuddy', Features: 'ఫీచర్లు', India: 'భారత్', Trust: 'నమ్మకం' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'ఇంటరాక్టివ్ సామర్థ్యాలు', heading: 'లోతుగా తెలుసుకోండి', headingAccent: 'CareBuddyని.' },
    testimonials: {
      eyebrow: 'నిజమైన కథలు',
      heading: 'ప్రతి రాష్ట్రంలో',
      headingAccent: 'వినిపించింది.',
      subhead: 'వారణాసిలోని అమ్మమ్మల నుండి ముంబైలోని వైద్యుల వరకు — CareBuddy మీ భాషలో మాట్లాడుతుంది.',
    },
    problems: {
      eyebrow: 'చూడండి',
      tabProblems: 'పోటీదారుల లోపాలు',
      tabSolutions: 'CareBuddy పరిష్కారాలు',
      badgeSolutions: 'CareBuddy సమాధానాలు',
      heading: 'ప్రతి హెల్త్ యాప్ ఎక్కడ తప్పు చేస్తుంది.',
      subhead: 'ఇప్పటి యాప్‌లు ఇంగ్లీష్ మాట్లాడే, పట్టణ, టెక్ నేర్పరులైన వినియోగదారుల కోసం తయారయ్యాయి. CareBuddy మిగతా వారందరి కోసం తయారైంది.',
      ...
      solutions: [
        { headline: 'గ్రామీణ భారతదేశం కోసం రూపొందించబడింది', sub: 'తక్కువ వేగం ఇంటర్నెట్, ఏ ఫోన్ అయినా, ఏ భాష అయినా — మిగతావి పనిచేయని చోట CareBuddy పనిచేస్తుంది.' },
        ...
        { headline: 'ఒక రికార్డు, అందరు వైద్యులు', sub: 'Practo నుండి Apollo మరియు స్థానిక క్లినిక్ వరకు — CareBuddy అన్నింటినీ ఏకం చేస్తుంది.' },
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddy ఏమి చేస్తుంది',
      scrollHint: 'ఫీచర్లను చూడటానికి స్క్రోల్ చేయండి',
      featureWord: 'ఫీచర్',
      closingTitle: 'మరిన్ని త్వరలో వస్తాయి.',
      closingCta: 'Voice AI చూడండి ↓',
      cards: [
        { tag: 'భాష', title: 'చాట్', sub: 'మీ భాషలో, మీ మాండలికంలో', body: 'హిందీ, భోజ్‌పురి, తమిళం, హింగ్లిష్ — మీరు ఆలోచించే భాషలో CareBuddyని ఏదైనా అడగండి. దిగువ కుడి మూల నుండి విస్తరిస్తుంది.' },
        { tag: 'సంప్రదింపు', title: 'వాయిస్', sub: 'మాట్లాడండి — డాక్టర్ నివేదిక పొందండి', body: 'మీ లక్షణాలను బిగ్గరగా చెప్పండి. CareBuddy 10 క్లినికల్ ప్రశ్నలు అడిగి, నిర్మాణాత్మక నివేదికను రూపొందించి, మీ వైద్యుడికి పంపుతుంది.' },
        { tag: 'విజువల్ AI', title: 'స్కాన్', sub: 'మీ లక్షణాల ఫోటో తీయండి', body: 'దద్దుర్లు, కాలిన గాయం, జుట్టు సమస్యను ఫోటో తీయండి లేదా X-రే అప్‌లోడ్ చేయండి. CareBuddy దానిని చదివి శ్రద్ధ అవసరమైన వాటిని గుర్తిస్తుంది.' },
        { tag: 'కదలిక', title: 'యోగా', sub: 'రియల్-టైమ్ భంగిమ శిక్షణ', body: 'మీ కెమెరా ముందు ఒక భంగిమను పట్టుకోండి. CareBuddy రియల్ టైమ్‌లో మీ భంగిమను చూసి తదుపరిదానికి ఎప్పుడు వెళ్లాలో చెబుతుంది.' },
    ...
    chatbot: {
      title: 'CareBuddy సహాయకుడు',
      subtitle: 'మీ భాషలో లక్షణాల గురించి అడగండి',
      placeholder: 'మీ సందేశాన్ని టైప్ చేయండి…',
      greeting: 'హాయ్, నేను CareBuddy. మీకు ఏమి ఇబ్బందిగా ఉందో ఏ భాషలోనైనా చెప్పండి.',
  ...
  mr: {
    ...
    heroSubtitle:
      'तुमच्या भाषेत विचारा. लक्षणं बोला. प्रिस्क्रिप्शनचा फोटो काढा. CareBuddy त्वरित वैद्यकीय माहिती तुमच्या भाषेत सांगतो.',
    startConsultation: 'सल्ला सुरू करा',
    exploreFeatures: 'वैशिष्ट्ये पहा',
    consultG1: 'CareBuddy शी बोला',
    tapToExplore: 'वैशिष्ट्ये पाहण्यासाठी टॅप करा',
    chooseLanguage: 'तुमची भाषा निवडा',
    navItems: { 'Why CareBuddy': 'का CareBuddy', Features: 'वैशिष्ट्ये', India: 'भारत', Trust: 'विश्वास' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'इंटरॲक्टिव्ह वैशिष्ट्ये', heading: 'सखोल जाणून घ्या', headingAccent: 'CareBuddy बद्दल.' },
    testimonials: {
      eyebrow: 'खऱ्या कहाण्या',
      heading: 'प्रत्येक राज्यात',
      headingAccent: 'ऐकलं गेलं.',
      subhead: 'वाराणसीतील आजींपासून मुंबईतील डॉक्टरांपर्यंत — CareBuddy तुमच्या भाषेत बोलतो.',
    },
    problems: {
      eyebrow: 'पहा',
      tabProblems: 'स्पर्धकांच्या त्रुटी',
      tabSolutions: 'CareBuddy उपाय',
      badgeSolutions: 'CareBuddy उत्तरे',
      heading: 'प्रत्येक हेल्थ अ‍ॅप कुठे चुकतो.',
      subhead: 'सध्याचे अ‍ॅप्स इंग्रजी बोलणाऱ्या, शहरी, तंत्रज्ञान-जाणकार वापरकर्त्यांसाठी बनले होते. CareBuddy इतर सर्वांसाठी बनवले आहे.',
      ...
      solutions: [
        { headline: 'ग्रामीण भारतासाठी बनवले', sub: 'कमी वेगाचा इंटरनेट, कोणताही फोन, कोणतीही भाषा — CareBuddy तिथे काम करतो जिथे इतर करत नाहीत.' },
        ...
        { headline: 'एक रेकॉर्ड, सर्व डॉक्टर', sub: 'Practo पासून Apollo आणि स्थानिक दवाखान्यापर्यंत — CareBuddy सर्व एकत्र आणतो.' },
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddy काय करतो',
      scrollHint: 'वैशिष्ट्ये पाहण्यासाठी स्क्रोल करा',
      featureWord: 'फीचर',
      closingTitle: 'लवकरच आणखी येत आहे.',
      closingCta: 'Voice AI पहा ↓',
      cards: [
        { tag: 'भाषा', title: 'चॅट', sub: 'तुमच्या भाषेत, तुमच्या बोलीत', body: 'हिंदी, भोजपुरी, तमिळ, हिंग्लिश — तुम्ही जे विचार करता त्या भाषेत CareBuddy ला काहीही विचारा. खालच्या उजव्या कोपऱ्यातून विस्तारते.' },
        { tag: 'सल्ला', title: 'व्हॉइस', sub: 'बोला — डॉक्टर रिपोर्ट मिळवा', body: 'तुमची लक्षणे मोठ्याने सांगा. CareBuddy 10 क्लिनिकल प्रश्न विचारतो, एक संरचित अहवाल तयार करतो, आणि तो तुमच्या डॉक्टरांना पाठवतो.' },
        { tag: 'व्हिज्युअल AI', title: 'स्कॅन', sub: 'तुमच्या लक्षणांचा फोटो घ्या', body: 'पुरळ, भाजणे, केसांची समस्या यांचा फोटो घ्या किंवा एक्स-रे अपलोड करा. CareBuddy ते वाचतो आणि लक्ष देण्याची गरज असलेल्या गोष्टी सांगतो.' },
        { tag: 'हालचाल', title: 'योग', sub: 'रिअल-टाइम पवित्रा मार्गदर्शन', body: 'तुमच्या कॅमेऱ्यासमोर एक पवित्रा धरा. CareBuddy रिअल टाइममध्ये तुमचा फॉर्म पाहतो आणि पुढच्याकडे कधी जायचे ते सांगतो.' },
    ...
    chatbot: {
      title: 'CareBuddy सहाय्यक',
      subtitle: 'तुमच्या भाषेत लक्षणांबद्दल विचारा',
      placeholder: 'तुमचा संदेश टाइप करा…',
      greeting: 'नमस्कार, मी CareBuddy आहे. तुम्हाला काय त्रास होतोय ते कोणत्याही भाषेत सांगा.',
  ...
  gu: {
    ...
    heroSubtitle:
      'તમારી ભાષામાં પૂછો. તમારા લક્ષણો બોલો. પ્રિસ્ક્રિપ્શનનો ફોટો પાડો. CareBuddy તરત જ તબીબી માહિતી તમારી ભાષામાં સમજાવે છે.',
    startConsultation: 'પરામર્શ શરૂ કરો',
    exploreFeatures: 'સુવિધાઓ જુઓ',
    consultG1: 'CareBuddy સાથે વાત કરો',
    tapToExplore: 'સુવિધાઓ જોવા ટૅપ કરો',
    chooseLanguage: 'તમારી ભાષા પસંદ કરો',
    navItems: { 'Why CareBuddy': 'શા માટે CareBuddy', Features: 'સુવિધાઓ', India: 'ભારત', Trust: 'ભરોસો' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'ઇન્ટરેક્ટિવ ક્ષમતાઓ', heading: 'ઊંડાણમાં જાણો', headingAccent: 'CareBuddy ને.' },
    testimonials: {
      eyebrow: 'સાચી વાર્તાઓ',
      heading: 'દરેક રાજ્યમાં',
      headingAccent: 'સંભળાયું.',
      subhead: 'વારાણસીની દાદીઓથી લઈને મુંબઈના ડોક્ટરો સુધી — CareBuddy તમારી ભાષામાં વાત કરે છે.',
    },
    problems: {
      eyebrow: 'જુઓ',
      tabProblems: 'હરીફોની ખામીઓ',
      tabSolutions: 'CareBuddy ઉકેલો',
      badgeSolutions: 'CareBuddy જવાબો',
      heading: 'દરેક હેલ્થ એપ ક્યાં ભૂલ કરે છે.',
      subhead: 'હાલની એપ્સ અંગ્રેજી બોલતા, શહેરી, ટેક-જાણકાર વપરાશકર્તાઓ માટે બનેલી હતી. CareBuddy બાકીના બધા માટે બનાવવામાં આવ્યું છે.',
      ...
      solutions: [
        { headline: 'ગ્રામીણ ભારત માટે બનાવેલ', sub: 'ધીમો ઇન્ટરનેટ, કોઈપણ ફોન, કોઈપણ ભાષા — CareBuddy ત્યાં કામ કરે છે જ્યાં બીજા નથી કરતા.' },
        ...
        { headline: 'એક રેકોર્ડ, બધા ડોક્ટરો', sub: 'Practo થી Apollo અને સ્થાનિક ક્લિનિક સુધી — CareBuddy બધું એકસાથે લાવે છે.' },
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddy શું કરે છે',
      scrollHint: 'સુવિધાઓ જોવા સ્ક્રોલ કરો',
      featureWord: 'ફીચર',
      closingTitle: 'વધુ ટૂંક સમયમાં આવી રહ્યું છે.',
      closingCta: 'Voice AI જુઓ ↓',
      cards: [
        { tag: 'ભાષા', title: 'ચેટ', sub: 'તમારી ભાષામાં, તમારી બોલીમાં', body: 'હિન્દી, ભોજપુરી, તમિલ, હિંગ્લિશ — તમે જે ભાષામાં વિચારો છો તેમાં CareBuddyને કંઈ પણ પૂછો. નીચે જમણા ખૂણેથી વિસ્તરે છે.' },
        { tag: 'પરામર્શ', title: 'વૉઇસ', sub: 'બોલો — ડોક્ટર રિપોર્ટ મેળવો', body: 'તમારા લક્ષણો મોટેથી બોલો. CareBuddy 10 તબીબી પ્રશ્નો પૂછે છે, એક સંરચિત રિપોર્ટ બનાવે છે, અને તેને તમારા ડોક્ટરને મોકલે છે.' },
        { tag: 'વિઝ્યુઅલ AI', title: 'સ્કેન', sub: 'તમારા લક્ષણોનો ફોટો લો', body: 'ફોલ્લી, દાઝવું, વાળની સમસ્યાનો ફોટો લો અથવા X-રે અપલોડ કરો. CareBuddy તેને વાંચે છે અને ધ્યાન આપવા જેવું શું છે તે જણાવે છે.' },
        { tag: 'હલનચલન', title: 'યોગ', sub: 'રીયલ-ટાઇમ મુદ્રા માર્ગદર્શન', body: 'તમારા કેમેરા સામે એક મુદ્રા પકડી રાખો. CareBuddy રીયલ ટાઇમમાં તમારું સ્વરૂપ જુએ છે અને આગળ ક્યારે જવું તે કહે છે.' },
    ...
    chatbot: {
      title: 'CareBuddy સહાયક',
      subtitle: 'તમારી ભાષામાં લક્ષણો વિશે પૂછો',
      placeholder: 'તમારો સંદેશ ટાઇપ કરો…',
      greeting: 'નમસ્તે, હું CareBuddy છું. તમને શું તકલીફ છે તે કોઈપણ ભાષામાં કહો.',
  ...
  kn: {
    ...
    heroSubtitle:
      'ನಿಮ್ಮ ಭಾಷೆಯಲ್ಲಿ ಕೇಳಿ. ನಿಮ್ಮ ರೋಗಲಕ್ಷಣಗಳನ್ನು ಮಾತನಾಡಿ. ಪ್ರಿಸ್ಕ್ರಿಪ್ಷನ್ ಫೋಟೋ ತೆಗೆಯಿರಿ. CareBuddy ತಕ್ಷಣ ವೈದ್ಯಕೀಯ ಮಾಹಿತಿಯನ್ನು ನಿಮ್ಮ ಭಾಷೆಯಲ್ಲಿ ವಿವರಿಸುತ್ತದೆ.',
    startConsultation: 'ಸಮಾಲೋಚನೆ ಪ್ರಾರಂಭಿಸಿ',
    exploreFeatures: 'ವೈಶಿಷ್ಟ್ಯಗಳನ್ನು ನೋಡಿ',
    consultG1: 'CareBuddy ಜೊತೆ ಮಾತನಾಡಿ',
    tapToExplore: 'ವೈಶಿಷ್ಟ್ಯಗಳನ್ನು ನೋಡಲು ಟ್ಯಾಪ್ ಮಾಡಿ',
    chooseLanguage: 'ನಿಮ್ಮ ಭಾಷೆಯನ್ನು ಆರಿಸಿ',
    navItems: { 'Why CareBuddy': 'ಏಕೆ CareBuddy', Features: 'ವೈಶಿಷ್ಟ್ಯಗಳು', India: 'ಭಾರತ', Trust: 'ನಂಬಿಕೆ' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'ಸಂವಾದಾತ್ಮಕ ಸಾಮರ್ಥ್ಯಗಳು', heading: 'ಆಳವಾಗಿ ತಿಳಿಯಿರಿ', headingAccent: 'CareBuddy ಅನ್ನು.' },
    testimonials: {
      eyebrow: 'ನಿಜ ಕಥೆಗಳು',
      heading: 'ಪ್ರತಿ ರಾಜ್ಯದಲ್ಲಿ',
      headingAccent: 'ಕೇಳಿಬಂದಿದೆ.',
      subhead: 'ವಾರಣಾಸಿಯ ಅಜ್ಜಿಯಂದಿರಿಂದ ಮುಂಬೈನ ವೈದ್ಯರವರೆಗೆ — CareBuddy ನಿಮ್ಮ ಭಾಷೆಯಲ್ಲಿ ಮಾತನಾಡುತ್ತದೆ.',
    },
    problems: {
      eyebrow: 'ನೋಡಿ',
      tabProblems: 'ಪ್ರತಿಸ್ಪರ್ಧಿಗಳ ಕೊರತೆಗಳು',
      tabSolutions: 'CareBuddy ಪರಿಹಾರಗಳು',
      badgeSolutions: 'CareBuddy ಉತ್ತರಗಳು',
      heading: 'ಪ್ರತಿ ಆರೋಗ್ಯ ಆ್ಯಪ್ ಎಲ್ಲಿ ತಪ್ಪುತ್ತದೆ.',
      subhead: 'ಇರುವ ಆ್ಯಪ್‌ಗಳು ಇಂಗ್ಲಿಷ್ ಮಾತನಾಡುವ, ನಗರ, ತಂತ್ರಜ್ಞಾನ-ಪರಿಣತ ಬಳಕೆದಾರರಿಗಾಗಿ ನಿರ್ಮಿಸಲಾಗಿತ್ತು. CareBuddy ಉಳಿದೆಲ್ಲರಿಗಾಗಿ ನಿರ್ಮಿಸಲಾಗಿದೆ.',
      ...
      solutions: [
        { headline: 'ಗ್ರಾಮೀಣ ಭಾರತಕ್ಕಾಗಿ ನಿರ್ಮಿಸಲಾಗಿದೆ', sub: 'ಕಡಿಮೆ ವೇಗದ ಇಂಟರ್ನೆಟ್, ಯಾವುದೇ ಫೋನ್, ಯಾವುದೇ ಭಾಷೆ — ಇತರರು ಕೆಲಸ ಮಾಡದ ಕಡೆ CareBuddy ಕೆಲಸ ಮಾಡುತ್ತದೆ.' },
        ...
        { headline: 'ಒಂದು ದಾಖಲೆ, ಎಲ್ಲಾ ವೈದ್ಯರು', sub: 'Practo ನಿಂದ Apollo ಮತ್ತು ಸ್ಥಳೀಯ ಚಿಕಿತ್ಸಾಲಯದವರೆಗೆ — CareBuddy ಎಲ್ಲವನ್ನೂ ಒಗ್ಗೂಡಿಸುತ್ತದೆ.' },
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddy ಏನು ಮಾಡುತ್ತದೆ',
      ...
      cards: [
        { tag: 'ಭಾಷೆ', title: 'ಚಾಟ್', sub: 'ನಿಮ್ಮ ಭಾಷೆಯಲ್ಲಿ, ನಿಮ್ಮ ಉಪಭಾಷೆಯಲ್ಲಿ', body: 'ಹಿಂದಿ, ಭೋಜ್‌ಪುರಿ, ತಮಿಳು, ಹಿಂಗ್ಲಿಷ್ — ನೀವು ಯೋಚಿಸುವ ಭಾಷೆಯಲ್ಲಿ CareBuddy ಅನ್ನು ಏನಾದರೂ ಕೇಳಿ. ಕೆಳ ಬಲ ಮೂಲೆಯಿಂದ ವಿಸ್ತರಿಸುತ್ತದೆ.' },
        { tag: 'ಸಮಾಲೋಚನೆ', title: 'ಧ್ವನಿ', sub: 'ಮಾತನಾಡಿ — ವೈದ್ಯರ ವರದಿ ಪಡೆಯಿರಿ', body: 'ನಿಮ್ಮ ಲಕ್ಷಣಗಳನ್ನು ಗಟ್ಟಿಯಾಗಿ ಹೇಳಿ. CareBuddy 10 ಕ್ಲಿನಿಕಲ್ ಪ್ರಶ್ನೆಗಳನ್ನು ಕೇಳಿ, ರಚನಾತ್ಮಕ ವರದಿಯನ್ನು ರಚಿಸಿ, ಅದನ್ನು ನಿಮ್ಮ ವೈದ್ಯರಿಗೆ ಕಳುಹಿಸುತ್ತದೆ.' },
        { tag: 'ವಿಷುಯಲ್ AI', title: 'ಸ್ಕ್ಯಾನ್', sub: 'ನಿಮ್ಮ ಲಕ್ಷಣಗಳ ಫೋಟೋ ತೆಗೆಯಿರಿ', body: 'ದದ್ದು, ಸುಟ್ಟಗಾಯ, ಕೂದಲಿನ ಸಮಸ್ಯೆಯ ಫೋಟೋ ತೆಗೆಯಿರಿ ಅಥವಾ X-ರೇ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ. CareBuddy ಅದನ್ನು ಓದಿ ಗಮನ ಬೇಕಾದುದನ್ನು ಸೂಚಿಸುತ್ತದೆ.' },
        { tag: 'ಚಲನೆ', title: 'ಯೋಗ', sub: 'ರಿಯಲ್-ಟೈಮ್ ಭಂಗಿ ಮಾರ್ಗದರ್ಶನ', body: 'ನಿಮ್ಮ ಕ್ಯಾಮೆರಾ ಮುಂದೆ ಒಂದು ಭಂಗಿಯನ್ನು ಹಿಡಿದುಕೊಳ್ಳಿ. CareBuddy ರಿಯಲ್ ಟೈಮ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಭಂಗಿಯನ್ನು ನೋಡಿ ಮುಂದಿನದಕ್ಕೆ ಯಾವಾಗ ಹೋಗಬೇಕೆಂದು ಹೇಳುತ್ತದೆ.' },
    ...
    chatbot: {
      title: 'CareBuddy ಸಹಾಯಕ',
      subtitle: 'ನಿಮ್ಮ ಭಾಷೆಯಲ್ಲಿ ಲಕ್ಷಣಗಳ ಬಗ್ಗೆ ಕೇಳಿ',
      placeholder: 'ನಿಮ್ಮ ಸಂದೇಶವನ್ನು ಟೈಪ್ ಮಾಡಿ…',
      greeting: 'ನಮಸ್ಕಾರ, ನಾನು CareBuddy. ನಿಮಗೆ ಏನು ತೊಂದರೆ ಎಂದು ಯಾವುದೇ ಭಾಷೆಯಲ್ಲಿ ಹೇಳಿ.',
  ...
  pa: {
    ...
    heroSubtitle:
      'ਆਪਣੀ ਭਾਸ਼ਾ ਵਿੱਚ ਪੁੱਛੋ। ਆਪਣੇ ਲੱਛਣ ਬੋਲੋ। ਨੁਸਖੇ ਦੀ ਫੋਟੋ ਖਿੱਚੋ। CareBuddy ਤੁਰੰਤ ਡਾਕਟਰੀ ਜਾਣਕਾਰੀ ਤੁਹਾਡੀ ਭਾਸ਼ਾ ਵਿੱਚ ਸਮਝਾਉਂਦਾ ਹੈ।',
    startConsultation: 'ਸਲਾਹ ਸ਼ੁਰੂ ਕਰੋ',
    exploreFeatures: 'ਵਿਸ਼ੇਸ਼ਤਾਵਾਂ ਵੇਖੋ',
    consultG1: 'CareBuddy ਨਾਲ ਗੱਲ ਕਰੋ',
    tapToExplore: 'ਵਿਸ਼ੇਸ਼ਤਾਵਾਂ ਵੇਖਣ ਲਈ ਟੈਪ ਕਰੋ',
    chooseLanguage: 'ਆਪਣੀ ਭਾਸ਼ਾ ਚੁਣੋ',
    navItems: { 'Why CareBuddy': 'ਕਿਉਂ CareBuddy', Features: 'ਵਿਸ਼ੇਸ਼ਤਾਵਾਂ', India: 'ਭਾਰਤ', Trust: 'ਭਰੋਸਾ' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'ਇੰਟਰਐਕਟਿਵ ਸਮਰੱਥਾਵਾਂ', heading: 'ਡੂੰਘਾਈ ਨਾਲ ਜਾਣੋ', headingAccent: 'CareBuddy ਨੂੰ.' },
    testimonials: {
      eyebrow: 'ਸੱਚੀਆਂ ਕਹਾਣੀਆਂ',
      heading: 'ਹਰ ਰਾਜ ਵਿੱਚ',
      headingAccent: 'ਸੁਣੀਆਂ ਗਈਆਂ।',
      subhead: 'ਵਾਰਾਣਸੀ ਦੀਆਂ ਦਾਦੀਆਂ ਤੋਂ ਲੈ ਕੇ ਮੁੰਬਈ ਦੇ ਡਾਕਟਰਾਂ ਤੱਕ — CareBuddy ਤੁਹਾਡੀ ਭਾਸ਼ਾ ਬੋਲਦਾ ਹੈ।',
    },
    problems: {
      eyebrow: 'ਵੇਖੋ',
      tabProblems: 'ਮੁਕਾਬਲੇਬਾਜ਼ਾਂ ਦੀਆਂ ਕਮੀਆਂ',
      tabSolutions: 'CareBuddy ਦੇ ਹੱਲ',
      badgeSolutions: 'CareBuddy ਦੇ ਜਵਾਬ',
      heading: 'ਹਰ ਹੈਲਥ ਐਪ ਕਿੱਥੇ ਗ਼ਲਤ ਹੁੰਦਾ ਹੈ।',
      subhead: 'ਮੌਜੂਦਾ ਐਪਸ ਅੰਗਰੇਜ਼ੀ ਬੋਲਣ ਵਾਲੇ, ਸ਼ਹਿਰੀ, ਤਕਨੀਕ-ਜਾਣੂ ਵਰਤੋਂਕਾਰਾਂ ਲਈ ਬਣੇ ਸਨ। CareBuddy ਬਾਕੀ ਸਾਰਿਆਂ ਲਈ ਬਣਾਇਆ ਗਿਆ ਹੈ।',
      ...
      solutions: [
        { headline: 'ਪੇਂਡੂ ਭਾਰਤ ਲਈ ਬਣਾਇਆ ਗਿਆ', sub: 'ਹੌਲੀ ਇੰਟਰਨੈੱਟ, ਕੋਈ ਵੀ ਫੋਨ, ਕੋਈ ਵੀ ਭਾਸ਼ਾ — CareBuddy ਉੱਥੇ ਕੰਮ ਕਰਦਾ ਹੈ ਜਿੱਥੇ ਹੋਰ ਨਹੀਂ ਕਰਦੇ।' },
        ...
        { headline: 'ਇੱਕ ਰਿਕਾਰਡ, ਸਾਰੇ ਡਾਕਟਰ', sub: 'Practo ਤੋਂ Apollo ਅਤੇ ਸਥਾਨਕ ਕਲੀਨਿਕ ਤੱਕ — CareBuddy ਸਭ ਨੂੰ ਜੋੜਦਾ ਹੈ।' },
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddy ਕੀ ਕਰਦਾ ਹੈ',
      scrollHint: 'ਵਿਸ਼ੇਸ਼ਤਾਵਾਂ ਵੇਖਣ ਲਈ ਸਕ੍ਰੌਲ ਕਰੋ',
      featureWord: 'ਫੀਚਰ',
      closingTitle: 'ਹੋਰ ਜਲਦੀ ਆ ਰਿਹਾ ਹੈ।',
      closingCta: 'Voice AI ਵੇਖੋ ↓',
      cards: [
        { tag: 'ਭਾਸ਼ਾ', title: 'ਚੈਟ', sub: 'ਤੁਹਾਡੀ ਭਾਸ਼ਾ, ਤੁਹਾਡੀ ਬੋਲੀ ਵਿੱਚ', body: 'ਹਿੰਦੀ, ਭੋਜਪੁਰੀ, ਤਮਿਲ, ਹਿੰਗਲਿਸ਼ — CareBuddy ਨੂੰ ਉਸ ਭਾਸ਼ਾ ਵਿੱਚ ਕੁਝ ਵੀ ਪੁੱਛੋ ਜਿਸ ਵਿੱਚ ਤੁਸੀਂ ਸੋਚਦੇ ਹੋ। ਹੇਠਾਂ ਸੱਜੇ ਕੋਨੇ ਤੋਂ ਖੁੱਲ੍ਹਦਾ ਹੈ।' },
        { tag: 'ਸਲਾਹ', title: 'ਵੌਇਸ', sub: 'ਬੋਲੋ — ਡਾਕਟਰ ਰਿਪੋਰਟ ਲਵੋ', body: 'ਆਪਣੇ ਲੱਛਣ ਉੱਚੀ ਬੋਲੋ। CareBuddy 10 ਕਲੀਨਿਕਲ ਸਵਾਲ ਪੁੱਛਦਾ ਹੈ, ਇੱਕ ਢਾਂਚਾਗਤ ਰਿਪੋਰਟ ਬਣਾਉਂਦਾ ਹੈ, ਅਤੇ ਇਸਨੂੰ ਤੁਹਾਡੇ ਡਾਕਟਰ ਨੂੰ ਭੇਜਦਾ ਹੈ।' },
        { tag: 'ਵਿਜ਼ੁਅਲ AI', title: 'ਸਕੈਨ', sub: 'ਆਪਣੇ ਲੱਛਣਾਂ ਦੀ ਫੋਟੋ ਖਿੱਚੋ', body: 'ਧੱਫੜ, ਸੜਨ, ਵਾਲਾਂ ਦੀ ਸਮੱਸਿਆ ਦੀ ਫੋਟੋ ਖਿੱਚੋ ਜਾਂ ਐਕਸ-ਰੇ ਅੱਪਲੋਡ ਕਰੋ। CareBuddy ਇਸਨੂੰ ਪੜ੍ਹਦਾ ਹੈ ਅਤੇ ਦੱਸਦਾ ਹੈ ਕਿ ਧਿਆਨ ਦੀ ਲੋੜ ਕਿੱਥੇ ਹੈ।' },
        { tag: 'ਹਰਕਤ', title: 'ਯੋਗ', sub: 'ਰੀਅਲ-ਟਾਈਮ ਮੁਦਰਾ ਮਾਰਗਦਰਸ਼ਨ', body: 'ਆਪਣੇ ਕੈਮਰੇ ਸਾਹਮਣੇ ਇੱਕ ਮੁਦਰਾ ਰੱਖੋ। CareBuddy ਰੀਅਲ ਟਾਈਮ ਵਿੱਚ ਤੁਹਾਡਾ ਰੂਪ ਵੇਖਦਾ ਹੈ ਅਤੇ ਦੱਸਦਾ ਹੈ ਕਿ ਅਗਲੇ ਵੱਲ ਕਦੋਂ ਜਾਣਾ ਹੈ।' },
    ...
    chatbot: {
      title: 'CareBuddy ਸਹਾਇਕ',
      subtitle: 'ਆਪਣੀ ਭਾਸ਼ਾ ਵਿੱਚ ਲੱਛਣਾਂ ਬਾਰੇ ਪੁੱਛੋ',
      placeholder: 'ਆਪਣਾ ਸੁਨੇਹਾ ਲਿਖੋ…',
      greeting: 'ਸਤ ਸ੍ਰੀ ਅਕਾਲ, ਮੈਂ CareBuddy ਹਾਂ। ਤੁਹਾਨੂੰ ਕੀ ਤਕਲੀਫ਼ ਹੈ ਕਿਸੇ ਵੀ ਭਾਸ਼ਾ ਵਿੱਚ ਦੱਸੋ।',
  ...
  or: {
    ...
    heroSubtitle:
      'ନିଜ ଭାଷାରେ ପଚାରନ୍ତୁ। ଆପଣଙ୍କ ଲକ୍ଷଣ କୁହନ୍ତୁ। ପ୍ରେସକ୍ରିପସନ ର ଫଟୋ ଉଠାନ୍ତୁ। CareBuddy ତୁରନ୍ତ ଚିକିତ୍ସା ସୂଚନାକୁ ଆପଣଙ୍କ ଭାଷାରେ ବୁଝାଏ।',
    startConsultation: 'ପରାମର୍ଶ ଆରମ୍ଭ କରନ୍ତୁ',
    exploreFeatures: 'ବିଶେଷତା ଦେଖନ୍ତୁ',
    consultG1: 'CareBuddy ସହିତ କଥା ହୁଅନ୍ତୁ',
    tapToExplore: 'ବିଶେଷତା ଦେଖିବାକୁ ଟ୍ୟାପ କରନ୍ତୁ',
    chooseLanguage: 'ଆପଣଙ୍କ ଭାଷା ବାଛନ୍ତୁ',
    navItems: { 'Why CareBuddy': 'କାହିଁକି CareBuddy', Features: 'ବିଶେଷତା', India: 'ଭାରତ', Trust: 'ବିଶ୍ୱାସ' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'ଇଣ୍ଟରାକ୍ଟିଭ୍ ସକ୍ଷମତା', heading: 'ଗଭୀରରୁ ଜାଣନ୍ତୁ', headingAccent: 'CareBuddy କୁ.' },
    testimonials: {
      eyebrow: 'ପ୍ରକୃତ କାହାଣୀ',
      heading: 'ପ୍ରତ୍ୟେକ ରାଜ୍ୟରେ',
      headingAccent: 'ଶୁଣାଗଲା।',
      subhead: 'ବାରାଣାସୀର ଆଈମାନଙ୍କଠାରୁ ମୁମ୍ବାଇର ଡାକ୍ତରଙ୍କ ପର୍ଯ୍ୟନ୍ତ — CareBuddy ଆପଣଙ୍କ ଭାଷାରେ କଥା ହୁଏ।',
    },
    problems: {
      eyebrow: 'ଦେଖନ୍ତୁ',
      tabProblems: 'ପ୍ରତିଦ୍ୱନ୍ଦ୍ୱୀଙ୍କ ତ୍ରୁଟି',
      tabSolutions: 'CareBuddy ସମାଧାନ',
      badgeSolutions: 'CareBuddy ଉତ୍ତର',
      heading: 'ପ୍ରତ୍ୟେକ ହେଲ୍ଥ ଆପ୍ କେଉଁଠି ଭୁଲ୍ କରେ।',
      subhead: 'ପ୍ରଚଳିତ ଆପ୍‌ଗୁଡ଼ିକ ଇଂରାଜୀ କହୁଥିବା, ସହରୀ, ଟେକ୍-ଜାଣିଥିବା ଉପଯୋଗକାରୀଙ୍କ ପାଇଁ ତିଆରି ହୋଇଥିଲା। CareBuddy ବାକି ସମସ୍ତଙ୍କ ପାଇଁ ତିଆରି।',
      ...
      solutions: [
        { headline: 'ଗ୍ରାମୀଣ ଭାରତ ପାଇଁ ତିଆରି', sub: 'ମନ୍ଥର ଇଣ୍ଟରନେଟ୍, ଯେକୌଣସି ଫୋନ୍, ଯେକୌଣସି ଭାଷା — ଅନ୍ୟମାନେ କାମ ନକରୁଥିବା ସ୍ଥାନରେ CareBuddy କାମ କରେ।' },
        ...
        { headline: 'ଏକ ରେକର୍ଡ, ସମସ୍ତ ଡାକ୍ତର', sub: 'Practo ଠାରୁ Apollo ଏବଂ ସ୍ଥାନୀୟ କ୍ଲିନିକ୍ ପର୍ଯ୍ୟନ୍ତ — CareBuddy ସବୁକିଛି ଏକତ୍ର କରେ।' },
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddy କଣ କରେ',
      scrollHint: 'ବିଶେଷତା ଦେଖିବାକୁ ସ୍କ୍ରୋଲ କରନ୍ତୁ',
      featureWord: 'ବିଶେଷତା',
      closingTitle: 'ଆହୁରି ଶୀଘ୍ର ଆସୁଛି।',
      closingCta: 'Voice AI ଦେଖନ୍ତୁ ↓',
      cards: [
        { tag: 'ଭାଷା', title: 'ଚାଟ୍', sub: 'ଆପଣଙ୍କ ଭାଷାରେ, ଆପଣଙ୍କ ଉପଭାଷାରେ', body: 'ହିନ୍ଦୀ, ଭୋଜପୁରୀ, ତାମିଲ, ହିଙ୍ଗଲିଶ୍ — ଆପଣ ଭାବୁଥିବା ଭାଷାରେ CareBuddyକୁ କିଛି ବି ପଚାରନ୍ତୁ। ତଳ ଡାହାଣ କୋଣରୁ ବିସ୍ତାର ହୁଏ।' },
        { tag: 'ପରାମର୍ଶ', title: 'ଭଏସ୍', sub: 'କୁହନ୍ତୁ — ଡାକ୍ତର ରିପୋର୍ଟ ପାଆନ୍ତୁ', body: 'ଆପଣଙ୍କ ଲକ୍ଷଣ ଉଚ୍ଚ ସ୍ୱରରେ କୁହନ୍ତୁ। CareBuddy 10ଟି କ୍ଲିନିକାଲ୍ ପ୍ରଶ୍ନ ପଚାରି, ଏକ ସଂରଚିତ ରିପୋର୍ଟ ତିଆରି କରି, ତାହା ଆପଣଙ୍କ ଡାକ୍ତରଙ୍କୁ ପଠାଏ।' },
        { tag: 'ଭିଜୁଆଲ୍ AI', title: 'ସ୍କାନ୍', sub: 'ଆପଣଙ୍କ ଲକ୍ଷଣର ଫଟୋ ନିଅନ୍ତୁ', body: 'ଚର୍ମ ଫୁଟୁକୁଡ଼ି, ପୋଡ଼ା, ବାଳ ସମସ୍ୟାର ଫଟୋ ନିଅନ୍ତୁ କିମ୍ବା X-ରେ ଅପଲୋଡ୍ କରନ୍ତୁ। CareBuddy ଏହାକୁ ପଢ଼ି ଧ୍ୟାନ ଆବଶ୍ୟକ ଥିବା ବିଷୟ ଚିହ୍ନଟ କରେ।' },
        { tag: 'ଗତି', title: 'ଯୋଗ', sub: 'ରିଅଲ୍-ଟାଇମ୍ ମୁଦ୍ରା ମାର୍ଗଦର୍ଶନ', body: 'ଆପଣଙ୍କ କ୍ୟାମେରା ସାମ୍ନାରେ ଏକ ମୁଦ୍ରା ଧରି ରଖନ୍ତୁ। CareBuddy ରିଅଲ୍ ଟାଇମ୍‌ରେ ଆପଣଙ୍କ ଫର୍ମ ଦେଖି ପରବର୍ତ୍ତୀକୁ କେବେ ଯିବେ ତାହା କୁହେ।' },
    ...
    chatbot: {
      title: 'CareBuddy ସହାୟକ',
      subtitle: 'ଆପଣଙ୍କ ଭାଷାରେ ଲକ୍ଷଣ ବିଷୟରେ ପଚାରନ୍ତୁ',
      placeholder: 'ଆପଣଙ୍କ ସନ୍ଦେଶ ଟାଇପ୍ କରନ୍ତୁ…',
      greeting: 'ନମସ୍କାର, ମୁଁ CareBuddy। ଆପଣଙ୍କୁ କଣ ଅସୁବିଧା ହେଉଛି ଯେକୌଣସି ଭାଷାରେ କୁହନ୍ତୁ।',
  ...
  as: {
    ...
    heroSubtitle:
      'নিজৰ ভাষাত সোধক। আপোনাৰ লক্ষণ কওক। প্ৰেস্ক্ৰিপশ্যনৰ ফটো তুলক। CareBuddy তৎক্ষণাৎ চিকিৎসা তথ্য আপোনাৰ ভাষাত বুজাই দিয়ে।',
    startConsultation: 'পৰামৰ্শ আৰম্ভ কৰক',
    exploreFeatures: 'বৈশিষ্ট্য চাওক',
    consultG1: "CareBuddyৰ সৈতে কথা পাতক",
    tapToExplore: 'বৈশিষ্ট্য চাবলৈ টেপ কৰক',
    chooseLanguage: 'আপোনাৰ ভাষা বাছক',
    navItems: { 'Why CareBuddy': 'কিয় CareBuddy', Features: 'বৈশিষ্ট্য', India: 'ভাৰত', Trust: 'বিশ্বাস' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'ইণ্টাৰেক্টিভ্ ক্ষমতা', heading: 'গভীৰভাৱে জানক', headingAccent: 'CareBuddyক.' },
    testimonials: {
      eyebrow: 'সঁচা কাহিনী',
      heading: 'প্ৰতিটো ৰাজ্যত',
      headingAccent: 'শুনা গৈছে।',
      subhead: 'বাৰাণাসীৰ আইতাৰ পৰা মুম্বাইৰ ডাক্তৰলৈ — CareBuddyএ আপোনাৰ ভাষাত কথা কয়।',
    },
    problems: {
      eyebrow: 'চাওক',
      tabProblems: 'প্ৰতিদ্বন্দ্বীৰ কমী',
      tabSolutions: 'CareBuddyৰ সমাধান',
      badgeSolutions: 'CareBuddyৰ উত্তৰ',
      heading: 'প্ৰতিটো হেল্থ এপে ক\'ত ভুল কৰে।',
      subhead: 'বৰ্তমানৰ এপবোৰ ইংৰাজী কোৱা, চহৰীয়া, প্ৰযুক্তি-দক্ষ ব্যৱহাৰকাৰীৰ বাবে বনোৱা হৈছিল। CareBuddy বাকী সকলোৰে বাবে বনোৱা হৈছে।',
      ...
      solutions: [
        { headline: 'গ্ৰামীণ ভাৰতৰ বাবে বনোৱা', sub: 'লাহী ইণ্টাৰনেট, যিকোনো ফোন, যিকোনো ভাষা — আনে কাম নকৰা ঠাইত CareBuddyএ কাম কৰে।' },
        ...
        { headline: 'এটা ৰেকৰ্ড, সকলো ডাক্তৰ', sub: 'Practo ৰ পৰা Apollo আৰু স্থানীয় ক্লিনিকলৈ — CareBuddyএ সকলো একত্ৰিত কৰে।' },
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddyএ কি কৰে',
      scrollHint: 'বৈশিষ্ট্য চাবলৈ স্ক্ৰল কৰক',
      featureWord: 'বৈশিষ্ট্য',
      closingTitle: 'অধিক শীঘ্ৰে আহিছে।',
      closingCta: 'Voice AI চাওক ↓',
      cards: [
        { tag: 'ভাষা', title: 'চেট', sub: 'আপোনাৰ ভাষাত, আপোনাৰ উপভাষাত', body: 'হিন্দী, ভোজপুৰী, তামিল, হিংলিছ — আপুনি ভবা ভাষাত CareBuddyক যিকোনো প্ৰশ্ন কৰক। তলৰ সোঁফালৰ চুকৰ পৰা বিস্তাৰিত হয়।' },
        { tag: 'পৰামৰ্শ', title: 'ভইচ', sub: 'কওক — ডাক্তৰ ৰিপ\'ৰ্ট পাওক', body: 'আপোনাৰ লক্ষণ চিঞৰি কওক। CareBuddyএ 10টা ক্লিনিকেল প্ৰশ্ন সোধে, এটা গঠনমূলক ৰিপ\'ৰ্ট তৈয়াৰ কৰে, আৰু ইয়াক আপোনাৰ ডাক্তৰলৈ পঠায়।' },
        { tag: 'ভিজুৱেল AI', title: 'স্কেন', sub: 'আপোনাৰ লক্ষণৰ ফটো তুলক', body: 'ফুঁহুৰি, পোৰা, চুলিৰ সমস্যাৰ ফটো তুলক বা এক্স-ৰে আপল\'ড কৰক। CareBuddyএ ইয়াক পঢ়ি মনোযোগ দিব লগীয়া বস্তু চিহ্নিত কৰে।' },
        { tag: 'গতি', title: 'যোগ', sub: 'ৰিয়েল-টাইম আসন নিৰ্দেশনা', body: 'আপোনাৰ কেমেৰাৰ সন্মুখত এটা আসন ধৰি ৰাখক। CareBuddyএ ৰিয়েল টাইমত আপোনাৰ ফৰ্ম চাই পৰৱৰ্তীলৈ কেতিয়া যাব লাগে কয়।' },
    ...
    chatbot: {
      ...
      greeting: 'নমস্কাৰ, মই CareBuddy। আপোনাক কি অসুবিধা হৈছে যিকোনো ভাষাত কওক।',
  ...
  ur: {
    ...
    heroSubtitle:
      'اپنی زبان میں پوچھیں۔ اپنی علامات بولیں۔ نسخے کی تصویر کھینچیں۔ CareBuddy فوری طور پر طبی معلومات آپ کی زبان میں سمجھاتا ہے۔',
    startConsultation: 'مشاورت شروع کریں',
    exploreFeatures: 'خصوصیات دیکھیں',
    consultG1: 'CareBuddy سے بات کریں',
    tapToExplore: 'خصوصیات دیکھنے کے لیے ٹیپ کریں',
    chooseLanguage: 'اپنی زبان منتخب کریں',
    navItems: { 'Why CareBuddy': 'کیوں CareBuddy', Features: 'خصوصیات', India: 'بھارت', Trust: 'اعتماد' },
    heroTiles: [
    ...
    voiceGrid: { eyebrow: 'انٹرایکٹو صلاحیتیں', heading: 'گہرائی سے جانیں', headingAccent: 'CareBuddy کو.' },
    testimonials: {
      eyebrow: 'حقیقی کہانیاں',
      heading: 'ہر ریاست میں',
      headingAccent: 'سنی گئیں۔',
      subhead: 'وارانسی کی دادیوں سے لے کر ممبئی کے ڈاکٹروں تک — CareBuddy آپ کی زبان بولتا ہے۔',
    },
    problems: {
      eyebrow: 'دیکھیں',
      tabProblems: 'حریفوں کی خامیاں',
      tabSolutions: 'CareBuddy کے حل',
      badgeSolutions: 'CareBuddy کے جوابات',
      heading: 'ہر ہیلتھ ایپ کہاں غلطی کرتا ہے۔',
      subhead: 'موجودہ ایپس انگریزی بولنے والے، شہری، تکنیکی طور پر ماہر صارفین کے لیے بنائے گئے تھے۔ CareBuddy باقی سب کے لیے بنایا گیا ہے۔',
      ...
      solutions: [
        { headline: 'دیہی بھارت کے لیے بنایا گیا', sub: 'سست انٹرنیٹ، کوئی بھی فون، کوئی بھی زبان — CareBuddy وہاں کام کرتا ہے جہاں دوسرے نہیں کرتے۔' },
        ...
        { headline: 'ایک ریکارڈ، تمام ڈاکٹرز', sub: 'Practo سے Apollo اور مقامی کلینک تک — CareBuddy سب کچھ یکجا کرتا ہے۔' },
    ...
    horizontalScroll: {
      eyebrow: 'CareBuddy کیا کرتا ہے',
      scrollHint: 'خصوصیات دیکھنے کے لیے سکرول کریں',
      featureWord: 'فیچر',
      closingTitle: 'مزید جلد آ رہا ہے۔',
      closingCta: 'Voice AI دیکھیں ↓',
      cards: [
        { tag: 'زبان', title: 'چیٹ', sub: 'آپ کی زبان میں، آپ کی بولی میں', body: 'ہندی، بھوجپوری، تمل، ہنگلش — CareBuddy سے اس زبان میں کچھ بھی پوچھیں جس میں آپ سوچتے ہیں۔ نیچے دائیں کونے سے پھیلتا ہے۔' },
        { tag: 'مشاورت', title: 'آواز', sub: 'بولیں — ڈاکٹر رپورٹ حاصل کریں', body: 'اپنی علامات بلند آواز میں بولیں۔ CareBuddy 10 طبی سوالات پوچھتا ہے، ایک منظم رپورٹ بناتا ہے، اور اسے آپ کے ڈاکٹر کو بھیجتا ہے۔' },
        { tag: 'بصری AI', title: 'اسکین', sub: 'اپنی علامات کی تصویر لیں', body: 'خارش، جلن، بالوں کے مسئلے کی تصویر لیں یا ایکس رے اپ لوڈ کریں۔ CareBuddy اسے پڑھتا ہے اور بتاتا ہے کہ کس چیز پر توجہ درکار ہے۔' },
        { tag: 'حرکت', title: 'یوگا', sub: 'ریئل ٹائم کرنسی رہنمائی', body: 'اپنے کیمرے کے سامنے ایک کرنسی رکھیں۔ CareBuddy ریئل ٹائم میں آپ کی حالت دیکھتا ہے اور بتاتا ہے کہ اگلی طرف کب جانا ہے۔' },
    ...
    chatbot: {
      title: 'CareBuddy اسسٹنٹ',
      subtitle: 'اپنی زبان میں علامات کے بارے میں پوچھیں',
      placeholder: 'اپنا پیغام ٹائپ کریں…',
      greeting: 'سلام، میں CareBuddy ہوں۔ کسی بھی زبان میں بتائیں کہ آپ کو کیا تکلیف ہے۔',

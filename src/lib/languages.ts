...
export const COPY: Record<string, Copy> = {
  en: {
    ...
    chatbot: {
      ...
      mockReply: "Thanks for sharing. In the full version, G1 will ask a few more questions and put together a doctor-ready report for you.",
  ...
  hi: {
    ...
    chatbot: {
      ...
      mockReply: 'साझा करने के लिए धन्यवाद। पूर्ण संस्करण में, G1 कुछ और सवाल पूछेगा और आपके लिए डॉक्टर-तैयार रिपोर्ट बनाएगा।',
  ...
  bn: {
    ...
    chatbot: {
      ...
      mockReply: 'শেয়ার করার জন্য ধন্যবাদ। সম্পূর্ণ সংস্করণে, G1 আরও কিছু প্রশ্ন জিজ্ঞাসা করবে এবং আপনার জন্য একটি ডাক্তার-প্রস্তুত রিপোর্ট তৈরি করবে।',
  ...
  ta: {
    ...
    chatbot: {
      ...
      mockReply: 'பகிர்ந்ததற்கு நன்றி. முழு பதிப்பில், G1 இன்னும் சில கேள்விகளைக் கேட்டு உங்களுக்காக மருத்துவர் தயார் அறிக்கையை உருவாக்கும்.',
  ...
  te: {
    ...
    chatbot: {
      ...
      mockReply: 'పంచుకున్నందుకు ధన్యవాదాలు. పూర్తి వెర్షన్‌లో, G1 మరికొన్ని ప్రశ్నలు అడిగి మీ కోసం వైద్యుడికి సిద్ధంగా ఉన్న నివేదికను తయారు చేస్తుంది.',
  ...
  mr: {
    ...
    chatbot: {
      ...
      mockReply: 'शेअर केल्याबद्दल धन्यवाद. पूर्ण आवृत्तीत, G1 आणखी काही प्रश्न विचारेल आणि तुमच्यासाठी डॉक्टर-तयार अहवाल बनवेल.',
  ...
  gu: {
    ...
    chatbot: {
      ...
      mockReply: 'શેર કરવા બદલ આભાર. સંપૂર્ણ સંસ્કરણમાં, G1 થોડા વધુ પ્રશ્નો પૂછશે અને તમારા માટે ડોક્ટર-તૈયાર રિપોર્ટ બનાવશે.',
  ...
  kn: {
    ...
    chatbot: {
      ...
      mockReply: 'ಹಂಚಿಕೊಂಡಿದ್ದಕ್ಕೆ ಧನ್ಯವಾದಗಳು. ಪೂರ್ಣ ಆವೃತ್ತಿಯಲ್ಲಿ, G1 ಇನ್ನಷ್ಟು ಪ್ರಶ್ನೆಗಳನ್ನು ಕೇಳಿ ನಿಮಗಾಗಿ ವೈದ್ಯರ ಸಿದ್ಧ ವರದಿಯನ್ನು ತಯಾರಿಸುತ್ತದೆ.',
  ...
  pa: {
    ...
    chatbot: {
      ...
      mockReply: 'ਸਾਂਝਾ ਕਰਨ ਲਈ ਧੰਨਵਾਦ। ਪੂਰੇ ਵਰਜਨ ਵਿੱਚ, G1 ਕੁਝ ਹੋਰ ਸਵਾਲ ਪੁੱਛੇਗਾ ਅਤੇ ਤੁਹਾਡੇ ਲਈ ਡਾਕਟਰ-ਤਿਆਰ ਰਿਪੋਰਟ ਬਣਾਏਗਾ।',
  ...
  or: {
    ...
    chatbot: {
      ...
      mockReply: 'ସେୟାର କରିଥିବାରୁ ଧନ୍ୟବାଦ। ସମ୍ପୂର୍ଣ୍ଣ ସଂସ୍କରଣରେ, G1 ଆଉ କିଛି ପ୍ରଶ୍ନ ପଚାରିବ ଏବଂ ଆପଣଙ୍କ ପାଇଁ ଡାକ୍ତର-ପ୍ରସ୍ତୁତ ରିପୋର୍ଟ ତିଆରି କରିବ।',
  ...
  as: {
    ...
    chatbot: {
      ...
      mockReply: "শ্বেয়াৰ কৰাৰ বাবে ধন্যবাদ। সম্পূৰ্ণ সংস্কৰণত, G1এ আৰু কিছু প্ৰশ্ন সুধিব আৰু আপোনাৰ বাবে ডাক্তৰ-সাজু ৰিপ'ৰ্ট তৈয়াৰ কৰিব।",
  ...
  ur: {
    ...
    chatbot: {
      ...
      mockReply: 'شیئر کرنے کا شکریہ۔ مکمل ورژن میں، G1 مزید کچھ سوالات پوچھے گا اور آپ کے لیے ڈاکٹر کے لیے تیار رپورٹ بنائے گا۔',
